Rails.application.configure do
  ...
  config.action_mailer.asset_host = "http://#{ENV['HOST_NAME']}"
  ...
  # config.active_job.queue_name_prefix = "open-lesson-api_#{Rails.env}"
  ...
  config.middleware.insert_before 0, Rack::Cors do
    allow do
      ...
      resource '*', :headers => :any, :expose => ['Authorization'], :methods => [:get, :post, :options, :delete, :patch, :put]
    end
  end
