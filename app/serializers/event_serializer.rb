class EventSerializer < ActiveModel::Serializer
  attributes :id, :start_time, :end_time, :difficulty_level, :price, :women_only, :location, :guest_count, :event_registrations, :cancelled, :cards_accepted, :max_participants, :email
